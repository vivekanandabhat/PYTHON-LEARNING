...
# Uncomment below line and use proper variable and function names
# based on any more inputs that you would like to use
#xxx = get_extra_data()
# Modify the below function if you need to pass more parameters to it
